...
export default function CartedItemCard(props) {
    ...
    return (
        <div className="flex flex-row items-center py-4 pr-4 border-b-2 w-full relative carted-item-checkout-card">
            ...
            {props.isBeforePurchase && <p className="bi bi-x-square text-red-600 text-lg md:text-3xl absolute top-4 md:top-0 left-0 hover:text-red-700 md:static mr-6" onClick={deleteItem}></p>}
